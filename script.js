...
if (bookingForm) {
  bookingForm.addEventListener('submit', (e) => {
    ...
    const message = `*Halo, Fauzan Rentcar, saya ingin mengecek ketersediaan mobil:*%0A%0A*Nama:* ${data.name}%0A*Mulai:* ${data.startDate}%0A*Tujuan:* ${data.destination}%0A*Lama Sewa:* ${data.duration}%0A*Jumlah:* ${data.time}%0A*Mobil:* ${data.carType}%0A%0ATerima kasih!`;
